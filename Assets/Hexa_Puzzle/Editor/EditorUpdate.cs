...
class EditorUpdate
{
    ...
    static void Update()
    {
        ...
        string from = "Assets/Hexa_Puzzle/Plugins/Android/GoogleMobileAdsPlugin.androidlib";
        ...
        if (Directory.Exists(from) && !Directory.Exists(to))
        {
            ...
            AssetDatabase.MoveAsset("Assets/Hexa_Puzzle/Plugins/Android/googlemobileads-unity.aar", "Assets/Plugins/Android/googlemobileads-unity.aar");
        }

        from = "Assets/Hexa_Puzzle/Resources/BillingMode.json";
        ...
        if (File.Exists(from) && !File.Exists(to))
        {
            ...
            if (Directory.GetFiles("Assets/Hexa_Puzzle/Resources").Length == 0)
            {
                AssetDatabase.DeleteAsset("Assets/Hexa_Puzzle/Resources");
            }
        }
