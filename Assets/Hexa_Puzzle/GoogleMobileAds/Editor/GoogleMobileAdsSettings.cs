...
namespace GoogleMobileAds.Editor
{
    ...
    {
        private const string MobileAdsSettingsDir = "Assets/Hexa_Puzzle/GoogleMobileAds";

        private const string MobileAdsSettingsResDir = "Assets/Hexa_Puzzle/GoogleMobileAds/Resources";

        private const string MobileAdsSettingsFile =
            "Assets/Hexa_Puzzle/GoogleMobileAds/Resources/GoogleMobileAdsSettings.asset";
